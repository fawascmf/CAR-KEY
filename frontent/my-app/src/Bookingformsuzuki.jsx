    ...
    const onRegistration = async (e) => {
      ...
      try {
        ...
        const data = await axios.post(
          "http://localhost:5000/creatbookingsuzuki",
          bookarray,
          config
        );
        if (data) {
          navigate("/mybooking");
          alert("suzukibooking complet")
        } else {
          alert("not complet");
        }
        console.log(data);
...
<div>
  ...
  <div className="mainsideprop">
    ...
    <div className="secondmain">
      <h2 className="text-center" style={{ color: '#128650' }}>BOOKING FORM SUZUKI</h2>
      <br />
      <div>
        <Form>
          <Row className="mb-3">
...
export default Bookingformsuzuki