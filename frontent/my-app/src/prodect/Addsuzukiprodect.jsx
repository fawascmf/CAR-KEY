...
function Addsuzukiprodect() {
    const [suzukicreate, setSuzukicreat] = useState({
        name: "",
        price: "",
        image_url: "",
        color:"",
      ...
      const changes = (n) => {
        setSuzukicreat({...suzukicreate, [n.target.name]: n.target.value });
        console.log(setSuzukicreat);
      };
      ...
      const onRegistration = async (e) => {
        ...
        try {
          ...
          const data = await axios.post(
            "http://localhost:5000/suzukiproductcreat",
            suzukicreate,
            config
          );
          if (data) {
  ...
  return (
    <div><div className="mainsideprop">
    <div
      style={{
        float: "left",
        marginTop: "-1.5rem",
    ...
    <div className="secondmain">
      <h2 className="text-center" style={{color:'#128650'}}>ADD SUZUKI PRODECT</h2>
      <br />
      <div>
        <Form>
          <Row className="mb-3">
...
export default Addsuzukiprodect