          ...
          <MDBCard className="text-black">
            ...
            <MDBCardBody>
             ...
             <div className="d-flex justify-content-between total font-weight-bold mt-4">
              ...
              <br />
              <div>
        <Link to={`/bookingformhundai/${hundaiproduct._id}`}><center><button  type="button" class="btn btn-light"><span style={{color:'#128650',fontWeight:'bold'}}>BOOKING NOW</span></button></center></Link>
              </div>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
...
export default Hundaidetilpage;