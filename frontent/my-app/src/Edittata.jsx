...
function Edittata() {
    ...
    useEffect(() => {
      axios
        .get(`http://localhost:5000/tataget/${id}`)
    ...
    function handleSubmit() {
      axios
        .put(`http://localhost:5000/ubdatetata/${id}`, {
          name,
          price,
          image_url,
          description,
  ...
  return (
    ...
    <div className="secondmain">
      <h2 className="text-center" style={{color:'#128650'}}>EDIT TATA PRODECT</h2>
      <br />
      <div>
        <Form>
          <Row className="mb-3">
          ...
          <br />
          <center><Link to={"/tataprodectview"}><Button variant="success" type="submit" onClick={handleSubmit}> 
            Submit
          </Button>{" "} </Link>
